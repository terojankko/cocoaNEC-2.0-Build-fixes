...
- (void)drawHSV
{
    if ( hsvImage ) [ hsvImage drawInRect:NSMakeRect( 8, 7, 75, 75 ) fromRect:NSZeroRect operation:NSCompositingOperationSourceOver fraction:1.0 ] ;
}
...
{
	if ( ( [ event modifierFlags ] & NSEventModifierFlagControl ) != 0 ) return ;
