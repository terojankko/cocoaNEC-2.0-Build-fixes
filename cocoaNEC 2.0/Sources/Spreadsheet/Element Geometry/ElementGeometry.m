...
- (NSString*)ncForLoading:(int)index
{
	...
	case 1:
		//  series RLC
		perLength = ( [ seriesPerLength state ] == NSControlStateValueOn ) ;
	...
	case 2:
		//  parallel RLC
		perLength = ( [ parallelPerLength state ] == NSControlStateValueOn ) ;
...
- (void)addLoadToDict:(NSMutableDictionary*)base
{
	...
	case 1:
		...
		[ dict setObject:[ NSNumber numberWithBool:( [ seriesPerLength state ] == NSControlStateValueOn ) ] forKey:@"perLength" ] ;
		break ;
	case 2:
		//  parallel RLC
		...
		[ dict setObject:[ NSNumber numberWithBool:( [ parallelPerLength state ] == NSControlStateValueOn ) ] forKey:@"perLength" ] ;
		break ;
	case 3:
		//  impedance
...
- (void)restoreLoad:(NSDictionary*)dict
{
	...
	case 1:
		...
		[ seriesPerLength setState:( [ [ dict objectForKey:@"perLength" ] boolValue ] ) ? NSControlStateValueOn : NSControlStateValueOff ] ;
		break ;
	case 2:
		//  parallel RLC
		row = [ [ dict objectForKey:@"location" ] intValue ] ;
		...
		[ parallelPerLength setState:( [ [ dict objectForKey:@"perLength" ] boolValue ] ) ? NSControlStateValueOn : NSControlStateValueOff ] ;
		break ;
	case 3:
		//  impedance
		row = [ [ dict objectForKey:@"location" ] intValue ] ;
